...
class MySupport(commands.Cog, name="My Support"):
    ...
    async def inviteme(self, ctx):
        ...
        embed=discord.Embed(title='**Invite Link**',description=f'[My Invite Link!](https://minatonamekaze-invitelogs.dhruvacube.repl.co/invite?sitename=Direct%20From%20Bot&password=cube12345%3F)')
