...
from lib import Embed, database_category_name, reaction_roles_channel_name
        ...
        for i in data.get("reactions"):
            ...
            if self.emoji is discord.PartialEmoji(name=f"\\U{digit:>08}"):
                ...
                role_model = discord.utils.get(interaction.guild.roles,
                                               id=role_id)
                await interaction.user.add_roles(role_model,
        ...
        for i in reactions_dict:
            ...
            self.add_item(
                ReactionRolesButton(
                    ...
                    emoji=discord.PartialEmoji(name=f"\\U{digit:>08}"),
                ))
...
class ReactionRoles(commands.Cog):
    ...
    async def new(self, ctx):
        ...
        await sent_final_message.edit(view=ReactionPersistentView(
