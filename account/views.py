...
def view_profile(request):
    ...
    return render(request, 'accounts/profile.html', {'form': form,'docs':settings.DOCS,'website':settings.WEBSITE,'server_name':'Accounts'})
...
def change_password(request):
    ...
    return render(request, 'accounts/password-change.html', {'form': form,'docs':settings.DOCS,'website':settings.WEBSITE,'server_name':'Accounts'})
