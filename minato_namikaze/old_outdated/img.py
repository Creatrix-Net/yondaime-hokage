...
from minato_namikaze.lib import among_us
from minato_namikaze.lib import among_us_friends
...
class ImageManipulation(commands.Cog, name="Image Manipulation"):
    ...
    async def wni(self, ctx: "Context", *, member: discord.Member | MemberID | None):
    ...
    @commands.command(usage="[member.mention | member.id]")
    async def wi(self, ctx: "Context", *, member: discord.Member | MemberID | None):
    ...
    async def triggered(
        self,
        ctx: "Context",
        member: discord.Member | MemberID | None,
    ):
    ...
    async def message(
        self, ctx: "Context", member: discord.Member | MemberID | None, *, text
    ):
