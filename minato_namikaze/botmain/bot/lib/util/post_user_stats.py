...
class PostStats:
    ...
    async def post_guild_stats_all(self):
        ...
        e1.add_field(
            name='TopGG', value=f'{a.status} : [TopGG](https://top.gg/bot/{self.bot.user.id})')
        ...
        e1.add_field(name='BotsForDiscord', value=str(
            c.status)+f' : [BotsForDiscord](https://botsfordiscord.com/bot/{self.bot.user.id})')
        e1.add_field(name='DiscordListSpace', value=str(
            d.status)+f' : [DiscordListSpace](https://discordlist.space/bot/{self.bot.user.id})')
        e1.add_field(name='DiscordBoats', value=str(
            e.status)+f' : [DiscordBoats](https://discord.boats/bot/{self.bot.user.id})')
        e1.add_field(name='DiscordBots', value=str(
            f.status)+f' : [DiscordBots](https://discord.bots.gg/bots/{self.bot.user.id}/)')

        e1.add_field(name='Space Bots', value=str(
            h.status)+f' : [Space Bots](https://space-bot-list.xyz/bots/{self.bot.user.id})')

        e1.add_field(name='Void Bots', value=str(
            i.status)+f' : [Void Bots](https://voidbots.net/bot/{self.bot.user.id}/)')
