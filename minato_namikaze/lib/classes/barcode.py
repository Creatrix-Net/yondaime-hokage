...
SIZE = "{0:.3f}mm"
COMMENT = "Autogenerated with pyBarcode {}".format("TrustyCogs")
...
class SVGWriter(BaseWriter):
    ...
    def _init(self, code: Iterable | Sequence | Iterator):
    ...
    def _create_module(self, xpos: int, ypos: int, width: int, color: int | str):
        """Creates a module
    ...
    def save(self, filename: str, output: str | bytes) -> str:
...
class Barcode:
    ...
    def save(self, filename: str, options: dict | None = None) -> str:
    ...
    def write(self, fp: IO, options: dict | None = None):
    ...
    def render(self, writer_options: dict | None = None):
