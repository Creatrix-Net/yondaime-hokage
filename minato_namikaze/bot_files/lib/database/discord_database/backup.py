...
from discord import StageChannel, TextChannel, VoiceChannel, CategoryChannel

class BackupDatabse:
    def __init__(self, ctx: Context):
        self.ctx = ctx
        self.channel = ctx.get_config_channel_by_name_or_id(ChannelAndMessageId.backup_channel.value)
