...
def downgrade() -> None:
    ...
    sa.Column('id', sa.BIGINT(), server_default=sa.text("nextval('premium_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(length=250), autoincrement=False, nullable=False),
    sa.Column('reaction_roles_amount', sa.SMALLINT(), autoincrement=False, nullable=False),
    sa.Column('reminders_amount', sa.SMALLINT(), autoincrement=False, nullable=False),
    sa.Column('reminder_amount_per_user', sa.SMALLINT(), autoincrement=False, nullable=False),
    sa.Column('no_vote_locked', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('configurable_prefix', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('no_of_servers_applicable', sa.SMALLINT(), autoincrement=False, nullable=False),
    ...
    sa.Column('premium_expiry', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.Column('blacklisted', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['premium_id'], ['premium.id'], name='user_premium_id_fkey'),
    ...
    sa.Column('reactions', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('limit_to_one', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('custom_id', sa.VARCHAR(length=250), autoincrement=False, nullable=False),
    sa.Column('jump_url', sa.VARCHAR(length=500), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('message_id', name='reaction_roles_pkey')
    )
    op.create_index('ix_reaction_roles_server_id', 'reaction_roles', ['server_id'], unique=False)
    op.create_index('ix_reaction_roles_message_id', 'reaction_roles', ['message_id'], unique=False)
    op.create_index('ix_reaction_roles_limit_to_one', 'reaction_roles', ['limit_to_one'], unique=False)
    op.create_index('ix_reaction_roles_jump_url', 'reaction_roles', ['jump_url'], unique=False)
    op.create_index('ix_reaction_roles_custom_id', 'reaction_roles', ['custom_id'], unique=False)
    op.create_table('server',
    sa.Column('id', sa.BIGINT(), autoincrement=True, nullable=False),
    sa.Column('premium_applier_user_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('blacklisted', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('show_404_commands_error', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['premium_applier_user_id'], ['user.id'], name='server_premium_applier_user_id_fkey'),
