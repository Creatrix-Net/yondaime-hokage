    ...
    async def hasvoted(self, ctx, member: Optional[Union[int, discord.Member]] = None):
        ...
        async with ctx.channel.typing():
            ...
            e.add_field(
                ...
                if d_list
                else f"Not Voted : {self.discordboats_site}",
            )
            e.add_field(
                name="**Void Bots**",
                value=f"Voted : {self.void_bots_site}"
                if e12
                else f"Not Voted : {self.void_bots_site}",
            )
            e.add_field(
                name="**Fates List**",
            ...
            e.add_field(
                ...
                if g1
                else f"Not Voted : {self.bladebot_bots_site}",
            )
            e.add_field(
                name="**DiscordListSpace**",
                value=f"Voted : {self.discordlistspacesite}"
                if g1
                else f"Not Voted : {self.discordlistspacesite}",
            )
