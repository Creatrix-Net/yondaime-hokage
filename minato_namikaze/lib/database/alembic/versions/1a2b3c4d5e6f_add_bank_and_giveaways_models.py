...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_bank_accounts_guild_id"),
        "bank_accounts",
        ["guild_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_bank_accounts_user_id"),
        "bank_accounts",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_giveaway_entries_giveaway_message_id"),
        "giveaway_entries",
        ["giveaway_message_id"],
        unique=False,
    )
